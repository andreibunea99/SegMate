# models/vanilla_segmate_v2.py
"""
Vanilla SegMate with EfficientNetV2 encoder (timm)
==================================================
Same architecture as segmate_v2.py (EfficientNetV2 encoder + alignment + ASPP + decoder + dense skips + heads),
but **VANILLA**:
- NO CBAM
- NO SE
...
Usage:
    ...
    model = SegMate(num_classes=9, in_channels=1, deep_supervision=True, encoder_name="tf_efficientnetv2_s")
"""
...
class SegMate(nn.Module):
    """
    Vanilla SegMate with EfficientNetV2 encoder.

    Uses timm for the encoder, keeping the decoder identical to CustomUNetPlusPlus layout,
    ...
    def __init__(
        ...
        print(f"[SegMate(Vanilla)] Initializing with encoder: {encoder_name}")
        ...
        print(f"[SegMate(Vanilla)] Encoder '{encoder_name}' loaded successfully")
        ...
        print(f"[SegMate(Vanilla)] Encoder feature channels: {enc_chs}")
