# models/segmate_mambaout_nose.py
"""
SegMateMambaOutNoSE - Ablation Study Model
==========================================
This is a copy of SegMateMambaOut with SE blocks removed from
skip connections to study the effect of SE+CBAM attention combination.

Changes from SegMateMambaOut:
...
Usage:
    from models.segmate_mambaout_nose import SegMateMambaOutNoSE
    model = SegMateMambaOutNoSE(num_classes=9, in_channels=1, deep_supervision=True, encoder_name="mambaout_tiny")
"""
...
class SegMateMambaOutNoSE(nn.Module):
    """
    SegMateMambaOut model with SE blocks removed from skip connections.
    ...
    def __init__(
        ...
        print(f"[SegMateMambaOutNoSE] Initializing with encoder: {encoder_name}")
        ...
        print(f"[SegMateMambaOutNoSE] Encoder '{encoder_name}' loaded successfully")
        ...
        print(f"[SegMateMambaOutNoSE] Encoder feature channels: {enc_chs}")
