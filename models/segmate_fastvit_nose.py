# models/segmate_fastvit_nose.py
"""
SegMateFastViTNoSE - Ablation Study Model
=========================================
This is a copy of SegMateFastViT with SE blocks removed from
skip connections to study the effect of SE+CBAM attention combination.

Changes from SegMateFastViT:
...
Usage:
    ...
    model = SegMateFastViTNoSE(num_classes=9, in_channels=1, deep_supervision=True, encoder_name="fastvit_t12")
"""
...
class SegMateFastViTNoSE(nn.Module):
    """
    SegMateFastViT model with SE blocks removed from skip connections.
    ...
    def __init__(
        ...
        print(f"[SegMateFastViTNoSE] Initializing with encoder: {encoder_name}")
        ...
        print(f"[SegMateFastViTNoSE] Encoder '{encoder_name}' loaded successfully")
