# models/segmate_v2.py
"""
SegMate with EfficientNetV2 encoder (timm)
==========================================
Same architecture as CustomUNetPlusPlus (CBAM/SE/ASPP/Decoder/Dense skips/heads),
but with EfficientNetV2 encoder instead of EfficientNet-B5.
...
class SegMate(nn.Module):
    """
    SegMate with EfficientNetV2 encoder.

    Uses timm for the encoder, keeping decoder identical to CustomUNetPlusPlus.
    Feature channels are aligned to (40, 64, 128, 176) for decoder compatibility.
    """
    def __init__(
        self,
        num_classes=9,
        ...
        print(f"[SegMate] Initializing with encoder: {encoder_name}")
        ...
        print(f"[SegMate] Encoder '{encoder_name}' loaded successfully")
        ...
        print(f"[SegMate] Encoder feature channels: {enc_chs}")
