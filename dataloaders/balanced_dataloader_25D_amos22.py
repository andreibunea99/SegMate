# balanced_dataloader_25D_amos22.py
"""
Balanced slice DataLoader for AMOS22 dataset - 2.5D
===================================================================
...
class ChunkedSliceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # ------------------ labels: keep your original logic ------------------
        lbl = lbl_data["data"]
...
def get_dataloaders_balanced_amos22(root: str, batch_size: int = 60, num_workers: int = 8):
